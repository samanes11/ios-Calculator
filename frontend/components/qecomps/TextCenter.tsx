...
export default (props: {
  ...
  return <>
    ...
    <div className={props.fontSize ? null : z.qestyles.flexibletxtsize} style={{
      fontSize: props.fontSize, width: "100%",
      textAlign: "center", color: "green", marginTop: 5, marginBottom: 5
    }}>
      {props.value} &nbsp;
      <div style={{ display: "inline-block", marginRight: 3, verticalAlign: "middle" }}>
        {props.copyval ? <img className={z.qestyles.menubtn} onClick={() => {
          Copy(props.copyval)

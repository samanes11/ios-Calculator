        ...
        <div id="div" className={z.qestyles.divsend} style={{
            ...
            <textarea
                ...
                style={{
                    ...
                    fontFamily: "inherit",
                    padding: state.uploadurls.length == 0 ? (z.lang.dir == "ltr" ? "8px 40px 8px 8px" : "8px 8px 8px 40px") : null,

                }}
                className={z.qestyles.txtsend} id="txt" dir="auto" spellCheck={false} defaultValue={state.text}
                onClick={() => {
            ...
            {props.readOnly ? null : <div style={{
                position: "absolute",
                right: z.lang.dir == "ltr" ? 0 : null,
                left: z.lang.dir == "rtl" ? 0 : null,
                bottom: 1,

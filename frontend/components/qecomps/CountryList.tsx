...
export default (props)=>
{
  ...
  if(props.countries)
  {
    ...
    countrylist = cnt.map((c,i)=>{
      if(i < 8)
      {
        return <div key={"cnt_"+c.country} className={z.qestyles.ci} onClick={()=>{
            props.on?props.on(c.code):null
            props.onclose?props.onclose():null
          }}><div className={z.qestyles.fl}
  ...
  return <WindowFloat title={props.title} onclose={props.onclose}>
    ...
    <f-c style={{direction:z.lang.dir as any, marginBottom:-5}}>
      <sp-2/>
      <sp-3/>
    ...
    <f-c>
    <sp-2/>
    <TextBox dir="ltr" placeholder={props.placeholder} defaultValue={search} on={t=> {search = t}}/>
    </f-c>
    <br-x/>
